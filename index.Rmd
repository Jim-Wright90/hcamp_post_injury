...
#added this object and can be joined to specific test objects with na.omit() to add gender variable for modeling 
gender_data <- test_time %>% 
  select(passport_id, user_gender) %>% 
  arrange(passport_id)
